		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nssamui5stocks-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nssamui5stocks-display": {
								"semanticObject": "nssamui5stocks",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.sam.ui5stocks",
									"url": sap.ui.require.toUrl("ns/sam/ui5stocks")
								}
							}
						}
					}
